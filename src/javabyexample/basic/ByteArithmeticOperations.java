...
public class ByteArithmeticOperations {
	...
	public static void main(String[] args){
		...
		System.out.println("Product = " + product); // 60 * 60 = 3600 which is 111000010000 in binary form. byte is a 8-bits data form. 
		//truncates into 8 bits of the data which is equivalent to 00010000 which is 16 in decimal.
