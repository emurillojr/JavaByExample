...
public class UnaryOperations {
	...
	public static void main(String[] args) {
		...
		System.out.println("After executing ++num1.  Number1: " + num1 + "  Number2: " + num2);
		System.out.println();
		// Pre increment assignment num2 = num1; num1 = num1 + 1; first you assign, then
		// increment the number
		num2 = num1++;
		System.out.println("After executing num2 = num1++.  Number1: " + num1 + "  Number2: " + num2);
		System.out.println();
		// Post increment assignment num1 = num1 + 1; num2 = num1; first you increment
		// the number, then assign the number
		num2 = ++num1;
		System.out.println("After executing num2 = ++num1.  Number1: " + num1 + "  Number2: " + num2);
